...
role: "Data mining, modeling, and evaluator app"
...
tags:
  ...
  - data-mining
highlights:
  - Modeled proficiency for 3,911 pre-scored ELL essays across six analytic measures.
  - Explored data mining, topic modeling, preprocessing, and ML notebooks for writing assessment.
  - Built an evaluator notebook app that produces score-oriented feedback and essay analysis.
collaborators:
  - name: Manish Kumar
...
- Prepared and explored essay data for downstream modeling.
- Built notebooks for data mining, topic modeling, and machine-learning experiments.
- Created an evaluator workflow that turns essay text into score-oriented feedback and analysis.
