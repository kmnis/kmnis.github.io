...
role: "Model training, inference notebooks, and Hugging Face demo"
...
tags:
  ...
  - image-generation
highlights:
  - Trained on 10,000 paired face and comic images from a synthetic Kaggle dataset.
  - Compared a convolutional variational autoencoder with a Pix2Pix GAN architecture.
  - Published an interactive Hugging Face demo for trying the portrait-to-comic workflow.
collaborators:
  - name: Manish Kumar
...
- Built end-to-end training and inference workflows for face-to-comic translation.
- Compared reconstruction-oriented VAE behavior with paired image-to-image GAN behavior.
- Packaged the result into a Hugging Face Space so people can try the model directly.
